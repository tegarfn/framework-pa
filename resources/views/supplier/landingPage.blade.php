...
<body style="background-color: #E1FFB1;">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Jadilah Supplier kami</h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Baju - Celana - Sepatu</p>
            <div class="text-center">
                <a href="/supplier" class="btn btn-info">DAFTAR</a>
            </div>
        </div>
    </header>
    <!-- Footer-->
    ...
    <div class="copyright py-4 text-center text-black">
        <div class="container"><small>Copyright &copy; TED Inventory 2022</small></div>
    </div>
