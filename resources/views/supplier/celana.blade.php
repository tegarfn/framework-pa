...
<a href="{{ route('celana.create')}}" class=""><Button class="btn btn-primary mb-3">Tambah</Button></a>
    <table class="table">
        <thead>
            <tr>
                <th scope="col">No</th>
            ...
            <tbody>
                ...
                <td>
                    <a href= {{ route('celana.show', $cl->id) }} class=""><Button class="btn btn-success mb-3">Detail</Button></a>
                </td>
